...
checks = {
    ...
    'production launch time is frozen exactly': 'MAINNET_REGISTRATION_OPEN_AT: i64 = 1_788_238_800' in constants,
    'mainnet program id is frozen exactly': 'declare_id!(\"DA214e5LFbj1WARXzu89k295azhKCGMFcVicsm7CsfpL\")' in source,
